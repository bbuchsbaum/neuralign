test_that("apply_alignment works with new subjects", {
  ...
  set.seed(333)
  # Training data
  train_data <- make_test_data_list(n_subjects = 3, n_features = 10, n_obs = 10)
  ...
  # New subject data
  new_adat <- make_test_alignment_data(n_subjects = 1, n_features = 10, n_obs = 10, subject_ids = "sub-04")
...
test_that("apply_alignment respects fit_new = FALSE", {
  ...
  new_adat <- make_test_alignment_data(n_subjects = 1, n_features = 10, n_obs = 10, subject_ids = "sub-03")
